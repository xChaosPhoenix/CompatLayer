...
/*
 * Edited version of Herbarium class MelonCropBehavior for harmony patch
 * Updated OnPlanted method to include new arguments
 */
public class MelonCropBehaviorPatched : CropBehavior
{
        ...
        double currentTotalHours)
    {
        ...
        {
            Vintagestory.API.Common.BlockEntity be = api.World.BlockAccessor.GetBlockEntity(vinePos);
